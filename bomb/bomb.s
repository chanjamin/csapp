...
00000000004010f4 <phase_6>:
  ...
  #  b in rbx,a in rax ,c in rsi,
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx # b=node0
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax # 
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi # 0x00007fffffffdf88
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx #  d=*num2
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) # *num2=d;
  4011c4:	48 83 c0 08          	add    $0x8,%rax # a=a->next;
  4011c8:	48 39 f0             	cmp    %rsi,%rax # not 
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx # rcx=332
